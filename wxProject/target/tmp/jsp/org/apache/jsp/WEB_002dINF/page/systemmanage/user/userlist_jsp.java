package org.apache.jsp.WEB_002dINF.page.systemmanage.user;
...
public final class userlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<style>\r\n");
      out.write("\t.kuangxian span.textbox.combo.datebox{width:150px!important;}\r\n");
      out.write("</style>\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th style=\"width:2.8%;\">用户名：</th>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"text1\" id=\"loginName_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t<th style=\"width:2.8%;\">用户状态：</th>\r\n");
      out.write("\t\t\t\t\t<td><select class=\"select1\" id=\"state_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"></select></td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th style=\"width:2.8%;\">创建时间：</th>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\" style=\"width: 15%;\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" class=\"text1\" style=\"height: 30px;\" id=\"createDate_start_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t&nbsp;至&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" class=\"text1\" style=\"height: 30px;\" id=\"createDate_end_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<th style=\"width:2.8%;\">所属部门：</th>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"text1\" id=\"dept_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"><input class=\"button\" type=\"button\" value=\"查询\" onclick=\"qryUserList();\"/></td>\r\n");
      out.write("<!-- \t\t\t\t\t<td><input class=\"button\" type=\"button\" value=\"查询\" onclick=\"qryUserList();\"/></td> -->\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t$('#state_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').initSelectOption(\"user_state\", \"--请选择--\", null);\r\n");
      out.write("\t\t\t$('#createDate_start_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').datebox({\r\n");
      out.write("\t\t\t    //required:true\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$('#createDate_end_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').datebox({\r\n");
      out.write("\t\t\t    //required:true\r\n");
      out.write("\t\t\t});\r\n");
      ...
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/user/initDetail\",{oper:'add'});\r\n");
      out.write("\t\t\t\t}else if(method=='view'){\r\n");
      out.write("\t\t\t\t\t$.jumpPage2('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/user/initDetail\",{oper:'view',id:id});\r\n");
      out.write("\t\t\t\t}else if(method=='edit'){\r\n");
      out.write("\t\t\t\t\t$.jumpPage2('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/user/initDetail\",{oper:'edit',id:id});\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/user/delete?id=\"+id,\r\n");
      out.write("\t\t\t\t\t\t\ttype : \"POST\",\r\n");
      ...
      out.write("\t\t\t    url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/user/search',\r\n");
      out.write("\t\t\t    idField:'id',\r\n");
      out.write("\t\t\t    toolbar:toolbar,\r\n");
      out.write("\t\t\t    columns:[[\r\n");
      out.write("\t\t\t\t\t{title:'用户名',field:'loginName',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'姓名',field:'name',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'所属地市',field:'city',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'所属部门',field:'dept',width:120,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'电话',field:'tel',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'E-mail',field:'email',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'已选角色ID',field:'roleIds',hidden:true},\r\n");
      out.write("\t\t\t\t\t{title:'已选角色',field:'roleNames',width:120,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'创建时间',field:'createDate',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'创建人ID',field:'creator',hidden:true},\r\n");
      out.write("\t\t\t\t\t{title:'创建人',field:'creatorName',width:60,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'用户状态',field:'state',width:60,align:'center',halign:'center'}\r\n");
      out.write("\t\t\t    ]],\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//查询\r\n");
      out.write("\t\tfunction qryUserList(){\r\n");
      out.write("\t\t\t$('#tb_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').datagrid('load', {\r\n");
      out.write("\t\t\t\tloginName: $('#loginName_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').val(),\r\n");
      out.write("\t\t\t\tstate: $('#state_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').val(),\r\n");
      out.write("\t\t\t\tcreateDate_start: $('#createDate_start_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').datebox('getValue'),\r\n");
      out.write("\t\t\t\tcreateDate_end: $('#createDate_end_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').datebox('getValue'),\r\n");
      out.write("\t\t\t\tdept: $('#dept_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').val()\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_0(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_0.setPermissionKeys("usermanage:add");
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_1(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_1.setPermissionKeys("usermanage:edit");
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_2(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_2.setPermissionKeys("usermanage:delete");

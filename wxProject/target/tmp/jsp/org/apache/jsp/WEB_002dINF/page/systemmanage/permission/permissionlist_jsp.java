...
public final class permissionlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').treegrid('getSelected');\r\n");
      ...
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/permission/initDetail\",{oper:'add',parentId:id});\r\n");
      out.write("\t\t\t\t}else if(method=='view'){\r\n");
      out.write("\t\t\t\t\t$.jumpPage2('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/permission/initDetail\",{oper:'view',id:id});\r\n");
      out.write("\t\t\t\t}else if(method=='edit'){\r\n");
      out.write("\t\t\t\t\t$.jumpPage2('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("',\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/permission/initDetail\",{oper:'edit',id:id});\r\n");
      out.write("\t\t\t\t}else if(method=='reload'){\r\n");
      out.write("\t\t\t\t\t$('#tb_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').treegrid('reload');\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/permission/delete?id=\"+id,\r\n");
      out.write("\t\t\t\t\t\t\ttype : \"POST\",\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//格式列\r\n");
      out.write("\t\t\tfunction format_isMenu(value,row,index){\r\n");
      ...
      out.write("\t\t\t    height:pageHeight-60,\r\n");
      out.write("\t\t\t   // title:'权限信息列表',\r\n");
      ...
      out.write("\t\t\t    url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/systemmanage/permission/search',\r\n");
      out.write("\t\t\t    idField:'id',\r\n");
      out.write("\t\t\t    treeField:'name',\r\n");
      out.write("\t\t\t    animate: true,\r\n");
      out.write("\t\t\t    toolbar:toolbar,\r\n");
      out.write("\t\t\t    columns:[[\r\n");
      out.write("\t\t\t\t\t{title:'名称',field:'name',width:200,align:'left',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'标识',field:'permissionKey',width:200,align:'left',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'菜单',field:'isMenu',width:80,align:'center',halign:'center',formatter: format_isMenu},\r\n");
      out.write("\t\t\t\t\t{title:'链接',field:'menuUrl',width:200,align:'left',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'图标',field:'menuIcon',width:80,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'排序',field:'orderNo',width:80,align:'center',halign:'center'},\r\n");
      out.write("\t\t\t\t\t{title:'父节点ID',field:'_parentId',hidden:true}\r\n");
      out.write("\t\t\t    ]],\r\n");
      ...
      out.write("\t\t\t\t\t  $('#tb_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').treegrid('collapseAll');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//查询\r\n");
      out.write("\t\tfunction qryPermissionList(){\r\n");
      out.write("\t\t\t$('#tb_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uuid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("').treegrid('load');\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t</script>\r\n");
      out.write("</div>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_0(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_0.setPermissionKeys("permissionmanage:add");
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_1(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_1.setPermissionKeys("permissionmanage:edit");
  ...
  private boolean _jspx_meth_shirox_hasAnyPermissions_2(PageContext _jspx_page_context)
    ...
    _jspx_th_shirox_hasAnyPermissions_2.setPermissionKeys("permissionmanage:delete");

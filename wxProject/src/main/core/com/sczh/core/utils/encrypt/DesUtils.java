...
public class DesUtils {
    ...
    public static String strEnc(String data, String key) {
		String firstKey = key;
		String secondKey = new StringBuffer(key).reverse().toString();
		char[] thirdKey = key.toCharArray();
		Arrays.sort(thirdKey);
		return new DesUtils().strEnc(data, firstKey, secondKey, new String(thirdKey));
	}
    ...
    public static String strDec(String data, String key) {
		...
		char[] thirdKey = key.toCharArray();
		Arrays.sort(thirdKey);
		return new DesUtils().strDec(data, firstKey, secondKey, new String(thirdKey));
	}
